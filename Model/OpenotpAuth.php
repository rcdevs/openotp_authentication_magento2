...
EOT;
	...
	private function soapRequest(){
		...
		try {
			$soap_client = new SoapClientTimeout($this->etcModuleDir.'/openotp.wsdl', $options);				
		} catch (Exception $e) {
			$GLOBALS['log']->error($e);
		}
...
class SoapClientTimeout extends \SoapClient {
	...
	$this->logger->log(\Monolog\Logger::DEBUG, "Your PHP installation is missing the SOAP extension");	
}
